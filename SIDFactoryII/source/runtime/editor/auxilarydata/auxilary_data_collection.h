...
namespace Editor
{
	...
	class AuxilaryDataSongOrderLists;
	...
	public:
		...
		AuxilaryDataSongOrderLists& GetSongOrderLists();
		const AuxilaryDataSongOrderLists& GetSongOrderLists() const;
	...
	private:
		...
		std::unique_ptr<AuxilaryDataSongOrderLists> m_SongOrderLists;
	};
}